                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  ...
                                  <input type="checkbox" value="1" id="permissions_{{$cat['link']}}_canread_{{$subcat['link']}}" {{($subcat['can_read'])?'checked':null}} name="permissions[{{$subcat['link']}}][can_read]">
                                </td>

                                <td class="text-center">
                                  <input type="hidden" value="0" name="permissions[{{$subcat['link']}}][can_create]">
                                  <input type="checkbox" value="1" id="permissions_{{$cat['link']}}_cancreate_{{$subcat['link']}}" {{($subcat['can_create'])?'checked':null}} name="permissions[{{$subcat['link']}}][can_create]">
                                </td>

                                <td class="text-center">
                                  <input type="hidden" value="0" name="permissions[{{$subcat['link']}}][can_update]">
                                  <input type="checkbox" value="1" id="permissions_{{$cat['link']}}_canupdate_{{$subcat['link']}}" {{($subcat['can_update'])?'checked':null}} name="permissions[{{$subcat['link']}}][can_update]">
                                </td>

                                <td class="text-center">
                                  <input type="hidden" value="0" name="permissions[{{$subcat['link']}}][can_delete]">
                                  <input type="checkbox" value="1" id="permissions_{{$cat['link']}}_candelete_{{$subcat['link']}}" {{($subcat['can_delete'])?'checked':null}} name="permissions[{{$subcat['link']}}][can_delete]">
                                </td>

                                <td class="text-center">
                                  <input type="hidden" value="0" name="permissions[{{$subcat['link']}}][access]">
                                  <input type="checkbox" value="1" id="permissions_{{$cat['link']}}_access_{{$subcat['link']}}" {{($subcat['access'])?'checked':null}} name="permissions[{{$subcat['link']}}][access]">
                                </td>
                              </tr>
                              @endif
                              @endforeach
