        ...
        <div class="iq-header-title w-100">
            <div class="row">
                <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                    <h4 class="card-title m-0">Offres</h4>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <div class="flex align-items-center list-user-action">
                              <span data-toggle="modal" data-target="#editoffres{{$offre->id}}">
                                <a data-toggle="tooltip" data-placement="top" title="Modifier" href="#"><i class="ri-pencil-line"></i></a>
                              </span>
                            <div class="modal fade" id="editoffres{{$offre->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{ route('system-dictionary.update',$offre->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
                                            <input type="hidden" class="form-control" id="action" name="action" value="offres">
                                            <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="offres" name="offres" value="{{ $offre->name }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 text-left">
                                                            <div class="form-group">
                                                                <label for="description">Description</label>
                                                                <textarea class="form-control" id="description" name="description" rows="3">{{ $offre->description }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <span data-toggle="modal" data-target="#deleteoffres{{$offre->id}}">
                                <a data-toggle="tooltip" data-placement="top" title="Supprimer" href="#"><i class="ri-delete-bin-line"></i></a>
                              </span>
                            <div class="modal fade" id="deleteoffres{{$offre->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{ route('system-dictionary.destroy',$offre->id) }}" method="post" >
                                            @csrf
                                            @method('delete')
                                            <input type="hidden" class="form-control" id="action" name="action" value="offres">
                                            <div class="modal-body">
