                            ...
                            <div class="iq-card">
                                <div class="iq-card-header d-flex justify-content-between">
                                    ...
                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                        <div class="dropdown">
                    <span class="dropdown-toggle dropdown-bg iq-bg-success" id="dropdownMenuButton1"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="p-3">
                                                        ...
                                                        <h3>1,125</h3>
                                                        <span class="text-success mt-3 d-inline-block w-100"><i
                                                                class="ri-arrow-up-fill mr-1"></i>+3.3%</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="p-3">
                                                        ...
                                                        <h3>3,897</h3>
                                                        <span class="text-danger mt-3 d-inline-block w-100"><i
                                                                class="ri-arrow-down-fill mr-1"></i>+10%</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 align-self-center">
                                                    <div id="chart-8"></div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="iq-card wow fadeInUp overflow-hidden" data-wow-delay="0.6s">
                                <div class="iq-card-header d-flex justify-content-between">
                                    ...
                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                        <div class="dropdown">
                    <span class="dropdown-toggle dropdown-bg iq-bg-secondary" id="dropdownMenuButton2"
                          data-toggle="dropdown">
