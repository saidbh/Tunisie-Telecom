        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-sm-6 bg-primary text-center">
                    <div class="sign-in-detail text-white" style="background: url({{asset("assets/images/login/tt.jpg")}}) no-repeat 0 0; background-size: cover; min-height:calc(100vh - 55px);">
